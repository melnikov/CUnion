...
#define DB_CLASS_FILE @"items_comitet.postkomsg.com"

@implementation CUComitetItemsModel

- (void)_initData
{
    _cache = [[CUServerManager sharedManager] getDBCache];
    _loader = [[CUServerManager sharedManager] makeLoader:CUServerLoaderComitetItems];
